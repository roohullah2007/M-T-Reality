...
function ListingDocuments({ forms = [] }) {
    return (
        <>
            <Head title="Listing Documents" />
            ...
            <div className="bg-white rounded-2xl shadow-sm p-6 sm:p-10 mb-6">
                <div className="text-center mb-6">
                    <div className="inline-flex items-baseline gap-1 mb-1">
                        <span
                            className="text-[28px] font-bold text-[#2BBBAD]"
                    ...
                    <p
                        className="text-[11px] tracking-[0.3em] text-[#111] font-semibold"
                        style={{ fontFamily: '"Instrument Sans", sans-serif' }}
                    >
                        REALTY GROUP
                    </p>
                ...
                <h1
                    className="text-center text-[20px] sm:text-[24px] font-semibold text-[#111] mb-4"
                    style={{ fontFamily: '"Instrument Sans", sans-serif' }}
                >
            ...
            {forms.length === 0 ? (
                <div className="bg-white rounded-2xl shadow-sm p-12 text-center">
                    ...
                    <p className="text-gray-500">
                        Listing documents will appear here once your admin uploads them.
                    </p>
                </div>
            ) : (
...
ListingDocuments.layout = (page) => <UserDashboardLayout children={page} title="Listing Documents" />;
