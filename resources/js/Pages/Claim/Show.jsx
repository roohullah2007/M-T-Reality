                                        ...
                                        <div>
                                            ...
                                            <form onSubmit={handleRegister} className="space-y-3">
                                                <div>
                                                    ...
                                                    <input type="text" value={registerForm.data.name} onChange={(e) => registerForm.setData('name', e.target.value)} className="w-full px-3 py-2.5 border rounded-xl focus:ring-[#2BBBAD] focus:border-[#2BBBAD]" required />
                                                    {registerForm.errors.name && <p className="text-xs text-red-600 mt-1">{registerForm.errors.name}</p>}
                                                </div>
                                                <div>
                                                    <label className="block text-sm font-medium text-gray-700 mb-1">Email</label>
                                                    <input type="email" value={registerForm.data.email} onChange={(e) => registerForm.setData('email', e.target.value)} className="w-full px-3 py-2.5 border rounded-xl focus:ring-[#2BBBAD] focus:border-[#2BBBAD]" required />
                                                ...
                                                <div>
                                                    ...
                                                    <input type="tel" value={registerForm.data.phone} onChange={(e) => registerForm.setData('phone', e.target.value)} className="w-full px-3 py-2.5 border rounded-xl focus:ring-[#2BBBAD] focus:border-[#2BBBAD]" />
                                                </div>
                                                <div>
                                                    <label className="block text-sm font-medium text-gray-700 mb-1">Password</label>
                                                    <input type="password" value={registerForm.data.password} onChange={(e) => registerForm.setData('password', e.target.value)} className="w-full px-3 py-2.5 border rounded-xl focus:ring-[#2BBBAD] focus:border-[#2BBBAD]" required />
                                ...
                                <div className="bg-white rounded-2xl p-6 shadow-sm border">
                                    ...
                                    <div className="space-y-3">
                                        {[
                                            ...
                                            { icon: QrCode, title: 'QR Code Stickers', desc: 'Buyers scan to see your listing' },
                                            { icon: DollarSign, title: 'Zero Fees', desc: 'No agent commissions or hidden costs' },
