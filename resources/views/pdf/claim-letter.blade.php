...
<body>
    ...
    <div class="recipient">
        ...
        @if($property->owner_mailing_address)
        {{ $property->owner_mailing_address }}<br>
        @endif
    </div>
    @endif

    <div class="greeting">
        Dear {{ $property->owner_name ?? 'Homeowner' }},
    </div>
    ...
    <div class="highlight-box">
        ...
        @if($property->price > 0)
        <div style="font-size: 16pt; font-weight: bold; margin-top: 6px;">${{ number_format($property->price, 0) }}</div>
        @endif
    </div>
    ...
    <div class="claim-section">
        ...
        <div class="claim-url">{{ $claimUrl }}</div>
    </div>

    @if($expiresAt)
    <div class="expiration-warning">
        <strong>Claim by {{ $expiresAt }}</strong> &mdash; this free listing offer expires soon!
    </div>
    @endif
