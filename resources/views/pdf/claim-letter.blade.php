...
<body>
    ...
    <div class="highlight-box">
        ...
        @if($property->price > 0)
        <div style="font-size: 16pt; font-weight: bold; margin-top: 8px;">${{ number_format($property->price, 0) }}</div>
        @endif
    </div>
    ...
    <div class="expiration-warning">
        <strong>Claim by {{ $expiresAt }}</strong> &mdash; this offer expires soon!
    </div>
    @endif
