...
@section('content')
    ...
    <p>Thank you for submitting your property listing to {{ config('app.name') }}. After reviewing your submission, we found some issues that need to be addressed before we can approve your listing.</p>
